...
output_mus_attribute = 'Fm' # Fin, Fout, Lmt, Lm, Lt, LmtDot, LmDot, Activity, CorrectedActivity, Fm, Ft, Fp, Strength, Ft0, Ft0Grad, PennationAngle, EPOTt, EPOTt, EPOTmt, Pt, Pm, Pmt, Pmet
...
test = GetOutput(macro_output = output, path = path_output_mus, number_mus = muscle_nbr_SUPR, attribute_name = output_mus_attribute,nbr_test = test_var,steps = nstep)
